<script context=module lang=ts>
   ...
   import {addToSubmission, fromBucket, getVarPrefix} from '$lib/supabase'
...
<form>
   ...
   <div class="flex flex-col justify-center">
      {#each relations as r}
         <SearchMultipleSelect bind:selects={relationMultiSelects[r]} 
         type={r}/>
      {/each}
   </div>
   <div class="divider"></div>
...
{:else if submitState == State.SUCCESS}
   ...
   <div class="btn" href="./create/{type}">Click here</div> <p>if you want to submit another one!</p>

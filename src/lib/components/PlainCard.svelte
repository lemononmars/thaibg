...
<a href="/{type}/{id}/{slug}">
   <div class="relative card w-64 pt-8 bg-base-100 card-compact shadow-xl transition ease-in-out hover:opacity-80 hover:scale-105 duration-30 group">
      <figure><img src="{getImageURL(type, picture)}" class="object-cover h-64 aspect-auto" alt="picture of {name}"

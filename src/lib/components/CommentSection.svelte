	...
	{:then res}
		{#if res}
			{#each res.comments as c}
				<div
					class="flex flex-row items-center border-2 border-primary p-2 gap-2 rounded-lg bg-base-200"
				>
			...
			<div class="flex flex-row gap-4 my-2">
				...
				<div class="w-full">
					<div class="form-control" method="post">
						<textarea class="textarea h-24 textarea-bordered" placeholder={$_('comment.add')} />
